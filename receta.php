...
<div class="site-wrapper">
  ...
  <div class="container">
    ...
    <div class="container">
        ...
        <br>
        <td></td>
        <td><form action="agregar_receta.php">
        <input id="colorletra" type="submit" name= "Agre_receta" value="Agregar receta" required="true"></input></form></td>
        <th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
        <td><form action="historial_receta.php">
        <input id="colorletra" type="submit" name= "histo_receta" value="Ver historial recetas" required="true"></input></form></td>
        <br>
        </table>
        </div>
    </div>
