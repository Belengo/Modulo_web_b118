    ...
    <div class="row" >
      <div class="panel panel-default">
        <div class="panel-heading">
          <div class="col-xs-4" align="left"><img class="img-thumbnail" src="imgs/medical.svg" onmouseover="this.width=55;this.height=55;" onmouseout="this.width=40;this.height=40;" onclick="window.location='agregar_medic.php'" width="40" height="40"><span>Nuevo<span>
          </div>  
